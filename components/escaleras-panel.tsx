    ...
    <>
      <section className="module-panel">
        ...
        <details className="data-card section-collapse" style={{ marginTop: "1rem" }}>
          <summary>
            <span>Escaleras del día en curso</span>
            ...
            <section className="collapse-stack" style={{ marginTop: "1rem" }}>
              <details className="data-card section-collapse">
                <summary>
                  ...
                  <span>{formatLongDate(selectedRecord.fechaVisita)}</span>
                </summary>
                <div className="section-collapse-body">
                  <div className="stack">
                    ...
                    <div className="data-card" style={{ padding: "1rem" }}>
                      ...
                      <div className="muted" style={{ marginTop: "0.5rem" }}>
                        {selectedRecord.passDeviceItems.length > 0
                          ? selectedRecord.passDeviceItems.map((item) => `${item.name} [${item.quantity}]`).join(", ")
              ...
              <details className="data-card section-collapse">
                ...
                <div className="section-collapse-body">
                  ...
                  <form action={entryAction} className="field-grid" autoComplete="off">
                    ...
                    <div className="field">
                      <input name="off8_value" type="number" step="0.01" defaultValue={selectedRecord.off8Value ?? ""} placeholder="Costo Off8" autoComplete="off" />
                    </div>
                    <div className="field">
                      <input name="ticket_amount" type="number" step="0.01" defaultValue={selectedRecord.ticketAmount ?? ""} placeholder="Ticket de compra" autoComplete="off" />
                    </div>
                    <div className="field">
                    ...
                    <div className="field" style={{ gridColumn: "1 / -1" }}>
                      <textarea name="retenciones" defaultValue={selectedRecord.retentions ?? ""} placeholder="Retenciones o faltas" autoComplete="off" />
                    </div>
                    <div className="field" style={{ gridColumn: "1 / -1" }}>
                      <textarea name="comentarios" defaultValue={selectedRecord.comments ?? ""} placeholder="Notas o comentarios" autoComplete="off" />
                    </div>
              ...
              <details className="data-card section-collapse">
                <summary>
                  ...
                  <span>{selectedRecord.manualItems.length} registros</span>
                </summary>
                <div className="section-collapse-body">
